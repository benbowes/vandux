...
describe('componentB', () => {
  ...
  it('should setup with initialState', () => {
    expect(componentDom.querySelector('[data-vx="componentB__name"]').textContent).to.equal('');
    expect(componentDom.querySelector('[data-vx="componentB__title"]').textContent).to.equal('');
    expect(componentDom.querySelector('[data-vx="componentB__value"]').textContent).to.equal('20');
  });
  ...
  it('should update "name" when interacted with', () => {
    ...
    expect(componentDom.querySelector('[data-vx="componentB__name"]').textContent).to.equal('Bill Blank');
  });
  ...
  it('should update "title" when interacted with', () => {
    ...
    expect(componentDom.querySelector('[data-vx="componentB__title"]').textContent).to.equal('Mr');
  });
  ...
  it('should update "value" when interacted with', () => {
    ...
    expect(componentDom.querySelector('[data-vx="componentB__value"]').textContent).to.equal('22');
  });
});
